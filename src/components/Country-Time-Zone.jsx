    ...
    return (
        <div className='w-full flex flex-col items-center md:flex-row'>
            ...
            <div className='flex flex-col space-y-3 justify-center w-full bg-blue-400/10 p-4 md:bg-transparent rounded-lg'>
                <h1 className='w-[70%] md:w-full mx-auto text-lg md:text-xl flex items-center space-x-2'><RiCheckboxMultipleFill size={27} color={'#3786FB'} /><span><b>Day : </b>{days[timezone?.day_of_week]}</span></h1>
